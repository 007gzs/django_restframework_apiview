...
def render_to_mail(subject, to, context, content='', template_name=None,
        extend_context=True,
        **kwargs):
    '''
    ...
    `extend_context`:   whether to extend context to match all mails to only if the `context` is a dict like object, default true
    ...
    for _to, _context in zip(to, context):
        ...
        msg = EmailMultiAlternatives(subject=subject, to=(_to, ), body='',
            **kwargs)

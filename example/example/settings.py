...
Generated by 'django-modeladmin startproject' using Django 1.11.
...
SECRET_KEY = '!ql$eoh)9xve(6f#xmbagot%wju9_t&4i-wg%7fc0s#c#gk#gz'
...
AUTHENTICATION_BACKENDS = (
    ...
    'example_app.backend.UserBackend',
)
